Spectrum is not just about plugins and scripts. This modding toolkit lets you create any automated game patch you want. Make sure you [have the latest source](https://github.com/Ciastex/Spectrum/wiki/Building-Spectrum-from-source#downloading-the-source-code) before continuing. This tutorial assumes you have a basic knowledge about .NET's IL code.
